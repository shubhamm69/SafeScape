...
1. By opening the issue for discussion: For instance, if you believe that you
   have uncovered a bug in Project, creating a new issue in the `SafeScape/Project-Sample`
...
3. By helping to resolve the issue: Typically this is done either in the form
   ...
   `SafeScape/Project-Sample` in a concrete and reviewable manner.

## Submitting a Bug Report

When opening a new issue in the `SafeScape/Project-Sample` issue tracker, please provide as much
