...
```text
$ git clone git@github.com:username/SafeScape.git
$ cd SafeScape
$ git remote add upstream https://github.com/shubhamm69/SafeScape.git
$ git fetch upstream
```
...
Fixes: https://github.com/shubhamm69/SafeScape/issues/1337
